...
const tutorialStepsConfig = {
    '/dashboard': [
        ...
        },
        {
            ...
            content: 'A continuación descarga y llena el archivo en formato CSV.',
        },
        {
            target: '.subir-zip',
            content: 'Sube el archivo zip con el poligono correspondiente a los datos indicados en el CSV.',
        },
        {
            target: '.subir-csv',
            content: 'Sube el archivo CSV con los datos previamente escritos.',
        },
        {
